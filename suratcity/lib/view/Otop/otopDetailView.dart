...
class otopDetailView extends StatefulWidget {
  otopDetailView({Key key, this.topicID}) : super(key: key);
  final String topicID;

  @override
  _otopDetailViewState createState() => _otopDetailViewState();
}

class _otopDetailViewState extends State<otopDetailView> {
  var userFullname;
  var uid;
  ...
  Future<List<AllList>> postNewsDetail(
    ...
    final response = await client.post(Uri.parse(Info().otopDetail),
