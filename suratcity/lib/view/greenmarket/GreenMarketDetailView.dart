...
import 'MarketCommentListView.dart';

var data;
List<String> imgList = [];
var fileList;

class GreenMarketDetailView extends StatefulWidget {
  GreenMarketDetailView({Key key, this.topicID, this.title}) : super(key: key);
  final String topicID;
  final String title;

  @override
  _GreenMarketDetailViewState createState() => _GreenMarketDetailViewState();
}

class _GreenMarketDetailViewState extends State<GreenMarketDetailView> {
  var userFullname;
  var uid;
  var isLoved = "";
  var isFav = "";
  ...
  void initState() {
    ...
    favFnName = "marketList";

    initLove(widget.topicID, "market");
  ...
  Future<List<AllList>> postNewsDetail(
    ...
    setState(() {
      ...
      shopTime = data['shopTime'].toString();
  ...
  updateLove(id) async {
    ...
    if (status == "success") {
      updatePrefLove(widget.topicID, "market");
      setState(() {
        love = tmpLove;
      });
      print("love : " + love);
                ...
                Container(
                  ...
                  if (shopTime != "")
                    Container(
                      ...
                      child: Row(
                        children: [
                          Image.asset('assets/images/market/clock.png',
                              width: 14, color: Color(0xFF8C1F78)),
                          Expanded(
                            child: Container(
                              margin: EdgeInsets.only(left: 6),
                              child: Text(
                  ...
                  if (shopPhone != "")
                    Container(
                      ...
                      child: Row(
                        children: [
                          Image.asset('assets/images/market/phone.png',
                              width: 14, color: Color(0xFF8C1F78)),
                          Expanded(
                            child: Container(
                              margin: EdgeInsets.only(left: 6),
                  ...
                  if (shopAddress != "")
                    Container(
                      ...
                      child: Row(
                        children: [
                          Image.asset('assets/images/market/pin.png',
                              width: 12, color: Color(0xFF8C1F78)),
                          Expanded(
                            child: Container(
                              margin: EdgeInsets.only(left: 6),
                              child: Text(
