...
class NewsDetailViewOld extends StatefulWidget {
  NewsDetailViewOld({Key key, this.topicID}) : super(key: key);
  final String topicID;

  @override
  _NewsDetailViewOldState createState() => _NewsDetailViewOldState();
}

class _NewsDetailViewOldState extends State<NewsDetailViewOld> {
  var userFullname;
  var uid;
