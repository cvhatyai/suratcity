...
class ServiceGuideDetailView extends StatefulWidget {
  ServiceGuideDetailView({Key key, this.topicID}) : super(key: key);
  final String topicID;

  @override
  _ServiceGuideDetailViewState createState() => _ServiceGuideDetailViewState();
}

class _ServiceGuideDetailViewState extends State<ServiceGuideDetailView> {
  var userFullname;
  var uid;
  ...
  Future<List<AllList>> postNewsDetail(
    ...
    final response = await client.post(Uri.parse(Info().serviceGuideDetail),
